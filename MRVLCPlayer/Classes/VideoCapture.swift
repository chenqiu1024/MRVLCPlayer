...
@objc class VideoSpec : NSObject {
    @objc init(fps:Int32, size:CGSize) {
        self.fps = fps
        self.size = size
    }
...
@objc class VideoCapture: NSObject, AVCaptureVideoDataOutputSampleBufferDelegate {
    ...
    @objc var imageBufferHandler: ImageBufferHandler?
    
    @objc init(cameraType: CameraType, preferredSpec: VideoSpec?, previewContainer: CALayer?)
    {
        super.init()
